...
/**
 * The full official Draw Steel skill list (57 skills), matching MCDM's
 * printed character sheet exactly — used by the Canvas builder, which
 * (unlike the ds-skills element above) has no external validator to work
 * around. Title-cased for display.
 */
export const FULL_SKILLS_BY_GROUP: Record<string, string[]> = {
